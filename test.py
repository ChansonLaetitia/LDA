...
i = "John's big idea isn't all that bad."

i = i.strip()
raw = i.lower()
tokenizer1 = SpaceTokenizer()
tokens1 = tokenizer1.tokenize(raw)

tokenizer2 = RegexpTokenizer(r'\w+')
tokens2 = tokenizer2.tokenize(raw)

tokens = []

for i in tokens1:
    tokens += tokenizer2.tokenize(i)

print (tokens1,tokens2,tokens)
'''
